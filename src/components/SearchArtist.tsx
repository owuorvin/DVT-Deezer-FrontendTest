...
import { setArtist } from "../store/songsSlice";
        ...
        {isSuccess && (
          ...
          >
            {data.data.map((artist: any) => (
              ...
              >
                <ListItemAvatar>
                  <Avatar alt="Remy Sharp" src={artist.artists?.picture_small} />
                </ListItemAvatar>
                <ListItemText
                  primary={artist.artists?.name}
                  secondary={
                    <React.Fragment>{artist.nb_fan} fans</React.Fragment>
                  }
                />
              </ListItem>
            ))}
